...
class TestGecModel(ModelTestCase):
    ...
    def test_gec_model_prediction(self):
        ...
        gec_model = GecBERTModel(vocab_path=self.vocab_path,
        ...
        assert final_batch == [['I', 'run', 'to','the','stores', 'every', 'day.'],
                               ['The', 'quick', 'brown','foxes','jumps','over',"Elmo's", 'laziest', 'friend']]
